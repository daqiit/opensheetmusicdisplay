import { BackendType, OpenSheetMusicDisplayLowVersion} from '../src/OpenSheetMusicDisplay';
...
var openSheetMusicDisplay = new OpenSheetMusicDisplayLowVersion("osmdCanvas",config);
var cursorTimer;
...
function loadMusicScore(strXml, left, right, drawFromMeasureNumber, drawUpToMeasureNumber) {
    ...
    openSheetMusicDisplay.setOptions({
        ...
        cursorsOptions: [{ color: '#ffe400', alpha: 0.3, follow: true }],
    });

    openSheetMusicDisplay.load(strXml).then(function () {
        openSheetMusicDisplay.zoom = 1;
...
backGroundColor.onclick=function () {
    openSheetMusicDisplay.drawMeasureBackGround(0,3);
}
