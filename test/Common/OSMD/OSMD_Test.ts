...
describe("OpenSheetMusicDisplay Main Export", () => {
    ...
    it("no container", (done: MochaDone) => {
        chai.expect(() => {
            return new OpenSheetMusicDisplayLowVersion(undefined);
        }).to.throw(/container/);
        done();
    });
    ...
    it("container", (done: MochaDone) => {
        ...
        chai.expect(() => {
            return new OpenSheetMusicDisplayLowVersion(div);
        }).to.not.throw(Error);
        done();
    });
    ...
    it("load MXL from string", (done: MochaDone) => {
        ...
        const div: HTMLElement = TestUtils.getDivElement(document);
        const opensheetmusicdisplay: OpenSheetMusicDisplayLowVersion = TestUtils.createOpenSheetMusicDisplay(div);
    ...
    describe("cursor with hidden instrument", () => {
        let osmd: OpenSheetMusicDisplayLowVersion;
        beforeEach(() => {
            const div: HTMLElement = TestUtils.getDivElement(document);
    ...
    describe("cursor", () => {
        let opensheetmusicdisplay: OpenSheetMusicDisplayLowVersion;
